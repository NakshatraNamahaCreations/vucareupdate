              ...
              <a onClick={() => filtercatsub(ele.category)}>
                <div className="row m-auto">
                  <img
                    ...
                    height={50}
                    categoryImg
                    src={`https://api.vijnanacademy.com/category/${ele?.categoryImg}`}
                    alt=""
                  />{" "}
                </div>
                <div className="row m-auto">
              ...
              {Banner.map((item) => (
                <div key={item._id} className="m-auto">
                  <img
                    ...
                    width={380}
                    height={180}
                    src={`https://api.vijnanacademy.com/webBanner/${item.banner}`}
                    alt=""
                  />
                </div>
              ))}
                  ...
                  <div key={ele._id} className="m-auto slider-item">
                    ...
                    >
                      ...
                      <img
                        width={150}
                        height={150}
                        src={`https://api.vijnanacademy.com/subcat/${ele?.subcatimg}`}
