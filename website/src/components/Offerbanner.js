...
function Banner() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get(
      "https://api.vijnanacademy.com/api/userapp/getallofferbanner"
    );
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "https://api.vijnanacademy.com/api/userapp/deleteofferbanner/" + id,
    })
                        ...
                        <tr key={i}>
                          ...
                          <td>
                            <img
                              ...
                              src={`https://api.vijnanacademy.com/offerbanner/${element.icon}`}
                              width={"50px"}
                              height={"50px"}
                            />
                          </td>
