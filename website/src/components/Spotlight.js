...
function Spotlight() {
  ...
  const getbannerimg = async () => {
    let res = await axios.get(
      "https://api.vijnanacademy.com/api/userapp/getallspotlightbanner"
    );
    if ((res.status = 200)) {
  ...
  const deletebannerimg = async (id) => {
    axios({
      method: "post",
      url: "https://api.vijnanacademy.com/api/userapp/deletespotlightbanner/" + id,
    })
                        ...
                        <tr key={i}>
                          ...
                          <td>
                            <img
                              ...
                              src={`https://api.vijnanacademy.com/spotlight/${element.banner}`}
                              width={"100px"}
                              height={"50px"}
                            />
                          </td>
