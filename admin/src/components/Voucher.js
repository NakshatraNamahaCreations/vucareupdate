...
function Voucher() {
  ...
  const getvoucher = async () => {
    let res = await axios.get("https://api.vijnanacademy.com/api/userapp/getvoucher");
    if ((res.status = 200)) {
  ...
  const deletevoucher = async (id) => {
    axios({
      method: "post",
      url: "https://api.vijnanacademy.com/api/userapp/deletevoucher/" + id,
    })
                    ...
                    <Form>
                      ...
                      <div className="row pt-3 justify-content-center">
                        <div className="col-md-1">
                          <button className=" vu-button vucare_btn" onClick={addvoucher}>Save</button>
                        </div>
                      </div>
                    </Form>
                  </div>
